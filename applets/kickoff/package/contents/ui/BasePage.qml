...
FocusScope {
    ...
    Kicker.TriangleMouseFilter {
        ...
        Loader {
            ...
            Keys.onDownPressed: plasmoid.rootItem.header.nextItemInFocusChain().forceActiveFocus(Qt.ForwardtabFocusReason)
        }
    }
    PlasmaCore.SvgItem {
        id: separator
    ...
    Loader {
        ...
        KeyNavigation.tab: plasmoid.rootItem.header.nextItemInFocusChain()
        KeyNavigation.left: sideBarLoader
        Keys.onUpPressed: plasmoid.rootItem.header.nextItemInFocusChain().forceActiveFocus(Qt.TabFocusReason)
    }
}
